...
export GRADLE_USER_HOME=$CACHE_HOME/-gradle
export PATH=$PATH:$GRADLE_HOME/bin

# https://maven.apache.org/
export MAVEN_HOME=$APP_HOME/-maven
export MAVEN_REPOSITORY_HOME=$CACHE_HOME/-maven
export M2_HOME=$MAVEN_HOME
export MAVEN_USER_HOME=$MAVEN_HOME
export PATH=$PATH:$MAVEN_HOME/bin

# https://projects.spring.io/spring-boot/
export SPRING_BOOT_CLI_HOME=$APP_HOME/-spring-boot-cli
...
export DOCKER_HOME=$APP_HOME/-docker
export MACHINE_STORAGE_PATH=$CACHE_HOME/-docker
...
export KUBECTL_HOME=$APP_HOME/-kubectl
export KUBECONFIG=$KUBECTL_HOME/kubectl-config.yml
export KUBECONFIG_SAVED=$KUBECONFIG
export PATH=$PATH:$KUBECTL_HOME

# https://kubernetes.io/docs/tasks/tools/install-minikube/
export MINIKUBE_BIN=$APP_HOME/-minikube
export MINIKUBE_HOME=$CACHE_HOME/-minikube
...
export HELM_HOME=$APP_HOME/-helm
export PATH=$PATH:$HELM_HOME

# https://github.com/mholt/caddy
# https://caddyserver.com/docs/cli
export CADDY_HOME=$APP_HOME/-caddy
export CADDYPATh=$CACHE_HOME/-caddy
export PATH=$PATH:$CADDY_HOME

# https://github.com/v2ray/v2ray-core
export V2RAY_HOME=$APP_HOME/-v2ray
...
export HUGO_HOME=$APP_HOME/-hugo
